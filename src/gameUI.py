...
class Display:
    ...
    def __init__(self, board, robberTile):
        ...
        self.city = pygame.image.load('../images/city.png')
        self.city = pygame.transform.scale(self.city, (self.screenWidth / 38, self.screenHeight / 38))

        # self.town = pygame.image.load('../images/town.png')
        # self.town = pygame.transform.scale(self.town, (self.screenWidth / 25, self.screenHeight / 25))

        # self.tile = pygame.image.load('../images/hex.png')
        # self.tile = pygame.transform.scale(self.tile, (int(self.screenWidth / 8), int(self.screenHeight / 8)))
        self.resourceTiles = {}
        self.resourceTiles['Wood'] = pygame.image.load('../images/wood.png')
        self.resourceTiles['Grain'] = pygame.image.load('../images/grain.png')
        self.resourceTiles['Ore'] = pygame.image.load('../images/ore.png')
        self.resourceTiles['Wool'] = pygame.image.load('../images/wool.png')
        self.resourceTiles['Brick'] = pygame.image.load('../images/brick.png')
        self.resourceTiles['Desert'] = pygame.image.load('../images/desert.png')
        ...
        self.background = pygame.image.load('../images/water.png')
        ...
        # Load the robber
        self.robber = pygame.image.load('../images/robber.png')
